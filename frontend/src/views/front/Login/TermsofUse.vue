<template>
  <v-row justify="center">
      <v-card >
        ...
        <base-material-card :color="color" class="px-5 py-10 scroll" height="300px">
          <template v-slot:heading>
            <div :class="class_header">
               AGREEMENT TO TERMSi
            </div>
          </template>
          <v-card-text :class="class_header">
              <div :class="class_body">
                These Terms of Use constitute a legally binding agreement made between you, whether personally or on behalf of an entity (“you”) and Near N Dear ("Company", “we”, “us”, or “our”), concerning your access to and use of the http://www.nearndear.ca website as well as any other media form, media channel, mobile website or mobile application related, linked, or otherwise connected thereto (collectively, the “Site”). You agree that by accessing the Site, you have read, understood, and agreed to be bound by all of these Terms of Use. IF YOU DO NOT AGREE WITH ALL OF THESE TERMS OF USE, THEN YOU ARE EXPRESSLY PROHIBITED FROM USING THE SITE AND YOU MUST DISCONTINUE USE IMMEDIATELY.</br>
        ...
        <base-material-card :color="color" class="px-5 py-10 scroll" height="300px">
         ...
         <base-material-card :color="color"  class="px-5 py-10 scroll" height="300px">
          ...
          <v-card-text :class="class_body">
            These Terms shall be governed by and defined following the laws of Canada. Near N Dear and yourself irrevocably consent that the courts of Canada shall have exclusive jurisdiction to resolve any dispute which may arise in connection with these terms.
          </v-card-text>
        </base-material-card>
        ...
        <base-material-card :color="color"  class="px-5 py-10 scroll" height="300px">
          ...
          <v-card-text :class="class_body">
            You agree to irrevocably submit all disputes related to Terms or the relationship established by this Agreement to the jurisdiction of the Canada courts. Near N Dear shall also maintain the right to bring proceedings as to the substance of the matter in the courts of the country where you reside or, if these Terms are entered into in the course of your trade or profession, the state of your principal place of business.
          </v-card-text>
        </base-material-card>
        ...
        <base-material-card :color="color"  class="px-5 py-10 scroll" height="300px">
          ...
          <v-card-text :class="class_body">
            ...
            All User Data is and will remain the exclusive property of Near N Dear or its Affiliates except that data which Company obtains independently of this Agreement or its relationship with Near N Dear. Company agrees that it shall collect, access, use, maintain, disclose or share User Data only to the extent necessary to deliver its services or fulfill its obligations under this Agreement. If Near N Dear Users become customers of Company independent of the activities contemplated under this Agreement, nothing in this Agreement shall restrict Company’s use of information it obtains through such separate activities.
          </v-card-text>
        </base-material-card>
        ...
        <base-material-card :color="color"  class="px-5 py-10 scroll" height="300px">
          ...
          <v-card-text :class="class_body">
            ...
            Near N Dear</br>
            570 Emerson St</br>
            Coquitlam, British Columbia V5B4R3</br>
            Canada</br>
            Phone: 7789866979</br>
            gunhee.ryan.lee@gmail.com</br>
        ...
        <v-card-actions>
          <v-spacer></v-spacer>
          <v-btn color="info" text @click="close()">Agree</v-btn>
        </v-card-actions>
    </v-card>
  ...
  export default {
    ...
    data() {
      return {
                items: [],
                color:'info',
                class_header:'display-2 font-weight-light',
                class_body:'display-1 font-weight-light'
             }
    }, 
